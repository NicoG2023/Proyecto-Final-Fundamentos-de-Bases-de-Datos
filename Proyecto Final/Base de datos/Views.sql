...
select u."UUID" as user_id, u.name as user_name, u.username, r.name as role_name, a.action, a.action_timestamp
from public."User" u 
join public."Role" r on u.role_fk = r.id
join public.user_activity_log a on u."UUID" = a.user_fk;
