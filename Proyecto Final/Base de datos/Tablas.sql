...
-- Started on 2024-04-27 11:36:50
...
--
-- TOC entry 3258 (class 2604 OID 24649)
...
--
-- TOC entry 3253 (class 2604 OID 24602)
...
--
-- TOC entry 3256 (class 2604 OID 24619)
...
--
-- TOC entry 3252 (class 2604 OID 24581)
...
--
-- TOC entry 3254 (class 2604 OID 24593)
...
--
-- TOC entry 3262 (class 2604 OID 24749)
...
--
-- TOC entry 3263 (class 2604 OID 24774)
...
--
-- TOC entry 3259 (class 2604 OID 24697)
...
--
-- TOC entry 3257 (class 2604 OID 24642)
...
--
-- TOC entry 3261 (class 2604 OID 24730)
...
--
-- TOC entry 3255 (class 2604 OID 24612)
...
--
-- TOC entry 3480 (class 0 OID 24646)
-- Dependencies: 229
-- Data for Name: Position; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public."Position" (id, name, description, department_fk) FROM stdin;
\.


--
-- TOC entry 3468 (class 0 OID 24584)
-- Dependencies: 217
...
--
-- TOC entry 3476 (class 0 OID 24622)
-- Dependencies: 225
-- Data for Name: User; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public."User" ("UUID", name, password, username, role_fk) FROM stdin;
\.


--
-- TOC entry 3475 (class 0 OID 24616)
-- Dependencies: 224
-- Data for Name: allowance; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.allowance (id, name, description) FROM stdin;
\.


--
-- TOC entry 3467 (class 0 OID 24578)
-- Dependencies: 216
-- Data for Name: deduction; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.deduction (id, name, description) FROM stdin;
\.


--
-- TOC entry 3470 (class 0 OID 24590)
-- Dependencies: 219
...
--
-- TOC entry 3481 (class 0 OID 24659)
-- Dependencies: 230
-- Data for Name: employee; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.employee ("UUID", employee_code, name, position_fk, lastname, email, status_fk, bank_account, salary, phone) FROM stdin;
\.


--
-- TOC entry 3489 (class 0 OID 24746)
-- Dependencies: 238
-- Data for Name: employee_allowances; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.employee_allowances (id, employee_fk, allowance_fk, payroll_type_fk, effective_date, date_created, amount) FROM stdin;
\.


--
-- TOC entry 3491 (class 0 OID 24771)
-- Dependencies: 240
-- Data for Name: employee_deductions; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.employee_deductions (id, employee_fk, deduction_fk, payroll_type_fk, amount, effective_date, date_created) FROM stdin;
\.


--
-- TOC entry 3483 (class 0 OID 24694)
-- Dependencies: 232
-- Data for Name: employee_extra_hours; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.employee_extra_hours (id, hours, amount, effective_date, date_created, employee_fk, payroll_type_fk) FROM stdin;
\.


--
-- TOC entry 3485 (class 0 OID 24713)
-- Dependencies: 234
-- Data for Name: payroll; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.payroll (id, paroll_type_fk, reference_number, status, date_from, date_to, date_created) FROM stdin;
\.


--
-- TOC entry 3478 (class 0 OID 24639)
-- Dependencies: 227
-- Data for Name: payroll_type; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.payroll_type (id, name) FROM stdin;
\.


--
-- TOC entry 3487 (class 0 OID 24727)
-- Dependencies: 236
-- Data for Name: payslip; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.payslip (id, payroll_fk, employee_fk, present, absent, salary, allowance_amount, net, deduction_amount, date_created) FROM stdin;
\.


--
-- TOC entry 3473 (class 0 OID 24609)
-- Dependencies: 222
-- Data for Name: status; Type: TABLE DATA; Schema: public; Owner: ud_admin
--

COPY public.status (id, name, comments) FROM stdin;
\.
...
--
-- TOC entry 3273 (class 2606 OID 24621)
...
--
-- TOC entry 3265 (class 2606 OID 24583)
...
--
-- TOC entry 3269 (class 2606 OID 24595)
...
--
-- TOC entry 3307 (class 2606 OID 24778)
...
--
-- TOC entry 3297 (class 2606 OID 24701)
...
--
-- TOC entry 3287 (class 2606 OID 24665)
...
--
-- TOC entry 3289 (class 2606 OID 24667)
...
--
-- TOC entry 3291 (class 2606 OID 24669)
...
--
-- TOC entry 3293 (class 2606 OID 24671)
...
--
-- TOC entry 3295 (class 2606 OID 24673)
...
--
-- TOC entry 3281 (class 2606 OID 24644)
...
--
-- TOC entry 3301 (class 2606 OID 24720)
...
--
-- TOC entry 3303 (class 2606 OID 24734)
...
--
-- TOC entry 3283 (class 2606 OID 24651)
...
--
-- TOC entry 3285 (class 2606 OID 24653)
...
--
-- TOC entry 3267 (class 2606 OID 24607)
...
--
-- TOC entry 3271 (class 2606 OID 24614)
...
--
-- TOC entry 3277 (class 2606 OID 24630)
...
--
-- TOC entry 3279 (class 2606 OID 24632)
...
--
-- TOC entry 3317 (class 2606 OID 24759)
...
--
-- TOC entry 3318 (class 2606 OID 24754)
...
--
-- TOC entry 3319 (class 2606 OID 24764)
...
--
-- TOC entry 3320 (class 2606 OID 24784)
...
--
-- TOC entry 3321 (class 2606 OID 24779)
...
--
-- TOC entry 3322 (class 2606 OID 24789)
...
--
-- TOC entry 3312 (class 2606 OID 24702)
...
--
-- TOC entry 3313 (class 2606 OID 24707)
...
--
-- TOC entry 3310 (class 2606 OID 24674)
...
--
-- TOC entry 3311 (class 2606 OID 24679)
...
--
-- TOC entry 3314 (class 2606 OID 24721)
...
--
-- TOC entry 3315 (class 2606 OID 24735)
...
--
-- TOC entry 3316 (class 2606 OID 24740)
...
--
-- TOC entry 3309 (class 2606 OID 24654)
...
--
-- TOC entry 3308 (class 2606 OID 24633)
...
-- Completed on 2024-04-27 11:36:51
